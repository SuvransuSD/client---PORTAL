...
``` bash
# dev server with hot reload at http://45.120.138.103:3000
$ npm start
```

Navigate to [http://45.120.138.103:3000](http://45.120.138.103:3000). The app will automatically reload if you change any of the source files.
